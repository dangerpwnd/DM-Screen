...
class CharClassModel(Base):
    ...
    # Association Tables
    equip_assoc = Table('Class_has_Equipment', Base.metadata,
    ...
    features = relationship('FeatureModel',
                            secondary=feature_assoc,
                            back_populates='classes'
    )

    skills = relationship('SkillModel',
                            secondary=skill_assoc,
                            back_populates='classes'
    )
